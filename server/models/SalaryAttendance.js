...
const salaryAttendanceSchema = new mongoose.Schema({
...
salaryAttendanceSchema.index({ userId: 1, monthYear: 1 }, { unique: true });
salaryAttendanceSchema.index({ exposed: 1 });

module.exports = mongoose.model('SalaryAttendance', salaryAttendanceSchema);